...
\newcommand{\preorderprime}{\preceq'}
...
\newcommand{\EVc}{\mathit{EV}^C}
\newcommand{\EVa}{\mathit{EV}^A}
...
\newcommand{\jwb}[1]{\note{black}{#1}}
\newcommand{\jwbtwo}[1]{\note{black}{#1}}
\newcommand{\jwbthree}[1]{\note{blue}{#1}}

\newcommand{\paolo}[1]{\note{black}{#1}}
\newcommand{\paolotwo}[1]{\note{black}{#1}}
\newcommand{\paolothree}[1]{\note{cyan}{#1}}
