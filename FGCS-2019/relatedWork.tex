...
If a measure of \textit{utility} is associated with elements of the graph, removing or redacting graph elements may reduce the residual utility, and may also result in loss of connectivity. The 
...
\jwbtwo{It is computed over a graph using a user-chosen set of nodes, with the purpose of obscuring information.}
