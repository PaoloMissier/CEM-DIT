...
\jwbthree{In this paper we are going to restrict ourselves to a model consisting only of $\en$, $\act$, and relations $\used$ and $\wgby$.}
\jwbthree{
