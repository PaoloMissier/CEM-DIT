...
\jwb{Decision: include a brief discussion on terminology somewhere that makes reviewer ones points, but disagree with them. } 

\jwb{ Say abstraction is the usual word in this context (PROV) for this work back up with references. (eg)  The second reviewer (more experienced in PROV?) has no difficulty with the term.} 
