...
\comment{The reviewer is wrong here. 'Group' returns a PROV graph. Group is defined using path closure, replace and extend. The rewiring is part of the definition, defined in replace. JWB to clarify. }
...
\item There is something wrong with the mathematical definition: $PG_{gu/ea}  ~~X~~ P(V) \rightarrow PG_{gu/ea}$
 ...
 \comment{define $\powerset$}
 \comment{number equations}

 \comment{This is not a definition, it's the type of the Group operator. (Page 14) Say this explicitly. JWB to do. }
